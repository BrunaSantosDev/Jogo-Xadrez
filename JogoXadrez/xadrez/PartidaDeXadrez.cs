...
namespace xadrez
{
    class PartidaDeXadrez
    {
        ...
        public Peca vulnuravelEnPassant { get; private set; }
        ...
        public void desfazMovimento(Posicao origem, Posicao destino, Peca pecaCapturada)
        {
            ...
            if(p is Peao)
            {
                if (origem.coluna != destino.coluna && pecaCapturada == vulnuravelEnPassant)
                {
